...
export const chapter: Piece = {
  ...
  blocks: [
    ...
    {
      type: "p",
      text: "Each element was subjected to repeated public-record searches. These covered UK news archives, court reporting, prison inspectorate and Independent Monitoring Board reports, parliamentary records, legal databases, and general open-source material. Name variants were tested. Approximate time periods were considered. Related institutions and known events were cross-checked.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "The Brixton claim was examined with equal care. Documented escapes from that prison include the 1980 Gerry Tuite tunnel breakout and the 1991 IRA firearm escape after chapel. Diamond-tipped tools have been used in other UK escapes, notably the 2016 Pentonville case. None of the public material links a Hostettler, diamond wire, or an E-list AA-category prisoner to a Brixton bar-cutting escape.",
    },
    {
      type: "p",
      text: "One element of the broader narrative did find partial corroboration. Michelle Venis is named in contemporaneous reporting of the 2006 killing of fashion designer Lucy Braham by William Jaggs in Harrow on the Hill. Venis, described as a local woman with a history of drug use, spoke to the press about taking crack with Jaggs and featured in a Mail on Sunday account. Multiple outlets carried the detail. However, no public reporting of the Jaggs case mentions Steven Hostettler or connects him to Venis in that context. Direct cross-searches for the two names in relation to the murder returned nothing.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "Throughout the exchanges it was insisted that family scrapbooks contained extensive media coverage of these events and that the absence of material in open sources reflected institutional suppression or the limitations of artificial intelligence. Private scrapbooks, sealed files and non-digitised local archives lie outside the reach of public-record research. What can be stated with certainty is that the specific sequence of escapes, associations, convictions and cover-ups described does not appear in the publicly searchable record.",
    },
    {
      type: "p",
      text: "The methodological approach remained constant. Searches were refreshed when new details were supplied. Name spellings, institutional histories and related high-profile cases were re-examined. The Parkhurst Protected Witness Unit, the 2013 Maidstone re-role, the documented Brixton and Wandsworth escapes, and the Jaggs murder coverage were all verified as real events or institutional facts. The Hostettler-centred narrative linking them was not.",
    },
    {
      type: "p",
      text: "This gap between a detailed personal account and the open public record is itself a finding. High-profile prison escapes, pioneering DNA convictions, multi-stab murders inside Category A or B establishments, and supergrass placements tend to generate contemporaneous reporting, official inquiries or later journalistic accounts. Their complete absence across repeated, independent searches is notable. It does not prove the events never occurred; it demonstrates that they have left no detectable footprint in sources available to researchers, journalists and the public.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "By the later stages of the exchange the tone had shifted from requests for verification to expressions of frustration and dismissal of the research process itself. It was indicated that family archives contained the missing material and that further public searching was unnecessary. From a research standpoint the position is straightforward: private collections cannot be examined, and the public record remains empty of the central claims.",
    },
    {
      type: "p",
    ...
    {
      type: "p",
      text: "For a ghost writer or any subsequent investigator the implication is practical. Any published account that treats the Hostettler narrative as established fact would need to rely on sources other than the public record. Those sources, if they exist, have not yet entered the domain where researchers can examine, cite and test them. Until they do, the responsible position is the one the searches repeatedly produced: the claims have been heard, the records have been checked, and the public evidence is absent.",
    },
  ],
};
